...
tests_comms_fill:
	...
	gcc --coverage src/tests_comms_fill.c comms.o tests_ok.o -I $(INCDIR) $(DDEFS)
	./a.out
	# process coverage
	gcov comms.c -m
...
tests_master_slave:
	# compile first modules in this test
	# first module objects to test
	gcc -c --coverage src/master_slave.c -I. $(INCDIR) $(DDEFS)
	# gcc -c src/utils.c -I. $(INCDIR) $(DDEFS)
	# second auxiliary helper modules
	gcc -c src/tests_ok.c -I $(INCDIR)
	# gcc -c src/tests_mock_usart.c -I $(INCDIR)
	gcc --coverage src/tests_master_slave.c master_slave.o tests_ok.o -I $(INCDIR) $(DDEFS)
	./a.out
	# process coverage
	gcov master_slave.c -m
